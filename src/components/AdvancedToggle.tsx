    ...
    <div className="mt-12 mb-12">
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-16 h-16 bg-[#F5A623]/10 rounded-full border border-[#F5A623]/20 group-hover:scale-110 group-hover:bg-[#F5A623]/20 transition-all duration-500">
          <Hexagon size={32} className={`text-[#F5A623] ${!showAdvanced ? "animate-pulse" : "rotate-180"} transition-transform duration-500`} />
        </div>
        
        <div className="text-center">
          <h3 className="text-xl font-bold text-[#F5A623] mb-1">
            {showAdvanced ? "Contraer bloque avanzado ↑" : "Ver bloque avanzado"}
          </h3>
